...
@Component({
  ...
  templateUrl: './carousel-lines-horizontal.component.html',
  styleUrls: ['./carousel-lines-horizontal.component.css']
})
export class CarouselLinesHorizontalComponent implements OnInit {
